...
#
#
# Last update: Sep 14, 2015 release 301
...
## ./Builds/hardware/arduino/sam/cores/arduino/syscalls_sam3.c.o needs to be mentioned again
#		$(call SHOW,"7.2-LINK",$@,.)

#		$(CXX) $(LDFLAGS) $(OUT_PREPOSITION)$@ -L$(OBJDIR) -Wl,--start-group ./Builds/hardware/arduino/sam/cores/arduino/syscalls_sam3.c.o $(SYSTEM_OBJS) $(LOCAL_OBJS) $(TARGET_A) -Wl,--end-group
#
